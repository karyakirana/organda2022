<x-metronics>
    ...
    @endif
    <x-molecules.card title="Data Teluk Lamong">
        <!--begin::Wrapper-->
        <div class="d-flex flex-stack mb-5">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3 justify-content-end" data-kt-docs-table-toolbar="base">
                <!--begin::Add customer-->
                <a href="{{route('lamong.form')}}" class="btn btn-primary" title="add Teluk Lamong">
                    Add Teluk Lamong
                </a>
                <!--end::Add customer-->

                <!--begin::Add customer-->
                <a href="{{route('lamong.index-blokir')}}" class="btn btn-primary" title="add Teluk Lamong">
                    Data Blokir
                </a>
                <!--end::Add customer-->
            </div>
                        ...
                        columnDefs: [
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="/transaksi/lamong/form/`+row.id_translamong+`" class="menu-link px-3" data-kt-docs-table-filter="edit_row">
                                        Edit
                                    </a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" onclick="blokir('`+row.id_translamong+`')" class="menu-link px-3" data-kt-docs-table-filter="blokir_row">
                                        Blokir
                                    </a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" onclick="destroy('`+row.id_translamong+`')" class="menu-link px-3" data-kt-docs-table-filter="delete_row">
                                        Delete
                                    </a>
                                </div>
                                <!--end::Menu item-->

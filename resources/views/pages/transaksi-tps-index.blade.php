    ...
    <x-molecules.card title="Data Sopir">
        ...
        <div class="d-flex flex-stack mb-5">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3 justify-content-end" data-kt-docs-table-toolbar="base">
                <!--begin::Add customer-->
                <a href="{{route('tps.form')}}" class="btn btn-primary" title="add TPS">
                    Add TPS
                </a>
                <!--end::Add customer-->

                <!--begin::Add customer-->
                <a href="{{route('tps.index.blokir')}}" class="btn btn-primary">
                    Data Blokir
                </a>
                <!--end::Add customer-->
            </div>
                    ...
                    dt = $("#datatables").DataTable({
                        ...
                        columnDefs: [
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" onclick="blokir('`+row.id_transaksitps+`')" class="menu-link px-3" data-kt-docs-table-filter="blokir_row">
                                        Blokir
                                    </a>
                                </div>
                                <!--end::Menu item-->

<x-metronics>
    ...
    @endif
    <x-molecules.card title="Data Mobil">
        <!--begin::Wrapper-->
        <div class="d-flex flex-stack mb-5">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3 justify-content-end" data-kt-docs-table-toolbar="base">
                <!--begin::Add customer-->
                <a href="{{route('mobil.form')}}" class="btn btn-primary" title="add Mobil">
                    Add Mobil
                </a>
                <!--end::Add customer-->

                <!--begin::Add customer-->
                <a href="{{route('mobil')}}" class="btn btn-primary" title="add Mobil">
                    Data UnBlokir
                </a>
                <!--end::Add customer-->
            </div>
            ...
            var KTDatatablesServerSide = function () {
                ...
                var initDatatable = function () {
                    dt = $("#datatables").DataTable({
                        ...
                        ajax: {
                            type : 'POST',
                            url: "{{route('mobil.datatables.blokir')}}",
                        },
                        columns: [
                            { data: 'id_mobil' },
                        ...
                        columnDefs: [
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="/master/mobil/form/`+row.id_mobil+`" class="menu-link px-3" data-kt-docs-table-filter="edit_row">
                                        Edit
                                    </a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" onclick="unBlokir('`+row.id_mobil+`')" class="menu-link px-3" data-kt-docs-table-filter="blokir_row">
                                        UnBlokir
                                    </a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" onclick="destroy('`+row.id_mobil+`')" class="menu-link px-3" data-kt-docs-table-filter="delete_row">
                                        Delete
                                    </a>
                                </div>
                                <!--end::Menu item-->

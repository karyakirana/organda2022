<x-metronics>
    ...
    @endif
    <x-molecules.card title="Data MyPertamina">
        <!--begin::Wrapper-->
        <div class="d-flex flex-stack mb-5">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3 justify-content-end" data-kt-docs-table-toolbar="base">
                ...
                <!--begin::Add customer-->
                <a href="{{route('mypertamina.index')}}" class="btn btn-primary" title="add Teluk Lamong">
                    Data UnBlokir
                </a>
                <!--end::Add customer-->
            </div>
        ...
        <script>
            var KTDatatablesServerSide = function () {
                ...
                var initDatatable = function () {
                    dt = $("#datatables").DataTable({
                        ...
                        ajax: {
                            type : 'POST',
                            url: "{{route('mypertamina.datatables.blokir')}}",
                        },
                        columns: [
                            { data: 'id_mypertamina' },
                        ...
                        columnDefs: [
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="/transaksi/mypertamina/form/`+row.id_mypertamina+`" class="menu-link px-3" data-kt-docs-table-filter="edit_row">
                                        Edit
                                    </a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" onclick="unBlokir('`+row.id_mypertamina+`')" class="menu-link px-3" data-kt-docs-table-filter="blokir_row">
                                        Un Blokir
                                    </a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" onclick="destroy('`+row.id_mypertamina+`')" class="menu-link px-3" data-kt-docs-table-filter="delete_row">
                                        Delete
                                    </a>
                                </div>
                                <!--end::Menu item-->
            ...
            function unBlokir(id)
            {
                Swal.fire({
                    ...
                    if(result.isConfirmed){
                        $.ajax({
                            url : '{{route("mypertamina.unblokir")}}',
                            method : 'post',
                            data : {
                                id : id
                            },

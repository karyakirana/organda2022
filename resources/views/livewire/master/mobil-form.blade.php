<div>
    <x-molecules.card title="Form Mobil">
        <div class="col-8">
            <x-atoms.input.group-horizontal name="id_mobil" label="ID" class="mb-5">
                <x-atoms.input.text wire:model.defer="id_mobil" disabled/>
            </x-atoms.input.group-horizontal>
            <x-atoms.input.group-horizontal name="nama_cust" label="Customer" class="mb-5">
                <x-atoms.input.text wire:model.defer="nama_cust" data-bs-toggle="modal" data-bs-target="#modalCustomer"/>
            </x-atoms.input.group-horizontal>
            <x-atoms.input.group-horizontal name="jenis_mobil" label="Jenis Mobil" class="mb-5">
                <x-atoms.input.select wire:model.defer="jenis_mobil">
                    <option>Select</option>
                    <option value="Trailer">Trailer</option>
                    <option value="Truck">Truck</option>
                </x-atoms.input.select>
            </x-atoms.input.group-horizontal>
            <x-atoms.input.group-horizontal name="nopol_mobil" label="NOPOL" class="mb-5">
                <x-atoms.input.text wire:model.defer="nopol_mobil"/>
            </x-atoms.input.group-horizontal>
        </div>
        <x-slot:footer>
            @if($update)

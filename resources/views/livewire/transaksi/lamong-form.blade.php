<div>
    <x-molecules.card title="Form Teluk Lamong">
        <div class="col-8">
            <x-atoms.input.group-horizontal name="id_translamong" label="ID" class="mb-5">
                <x-atoms.input.text wire:model.defer="id_translamong" disabled/>
            ...
            <x-atoms.input.group-horizontal name="nik_lamong" label="NIK" class="mb-5">
                <x-atoms.input.text wire:model.defer="nik_lamong" />
            </x-atoms.input.group-horizontal>
        </div>
